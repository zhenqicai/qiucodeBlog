package cn.qiucode.utils.alioss;

import cn.qiucode.exception.ImgException;
...
public class OSSClientUtil {
    ...
    public  String getUrl(String key) {
        ...
        if (url != null) {
            ...
            String urlRes=urlStr.substring(0,urlStr.indexOf("?"));
            return urlRes;//url.toString().substring(0,url.toString().indexOf("?"));
        }
        return null;
    }
}
